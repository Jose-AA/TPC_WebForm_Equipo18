...
<asp:Content ID="BodyContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <img src="FPF/home/h2.png" alt="portada" class="img-fluid"/>
...
<div class="container-fluid" style="background-color:lightgray; justify-content:center; margin-top: 50px; margin-bottom:50px;" >
  ...
  <figcaption class="blockquote-footer">
    <p>Estamos equipados con tecnología de última generación, siempre de vanguardia para darte los mejores resultados y cuidar tu cuerpo.</p>
  </figcaption>
</figure>
    </div>
  </div>
