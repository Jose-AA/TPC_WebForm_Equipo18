...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <main>
        ...
        <div style="margin-left: 20px; margin-right: 20px; margin-top: 50px; margin-bottom:50px ">
            <asp:DropDownList ID="UsuarioaCargar" runat="server" AutoPostBack="True" OnSelectedIndexChanged="UsuarioaCargar_SelectedIndexChanged" />
        </div>
